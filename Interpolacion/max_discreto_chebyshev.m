function[max]=max_discreto_chebyshev(numnodos,a,b,step)
%Programa que coge la funcion finterpolacion y calcula el error que se obtiene con diferente numero de nodos. Usa nodos de chebyshev
%NECESITA LAS FUNCIONES NODOSCHEBYSHEV Y FINTERPOLACION
%%%%%%%%%%%%ENTRADA%%%%%%%%%%%%%
...
%Ejemplo de invocacion: [max]=max_discreto_chebyshev([2:6],1,3,.02)
