function[]=alg_secanterec_polinomio(fun,x0,x1,error,iter,contador)
%Esta funcion busca la raiz entre dos puntos de una funcion mediante el algoritmo de la secante
%%%%%%%%%%%%ENTRADA%%%%%%%%%%%%%
...
%Ejemplo de invocacion:  alg_secanterec_funcion('funcionprueba',5,10,10^(-7))
...
if x0==x1 
	...
	if abs(x2-x1)<error|contador==iter|contador==497
	  ...
	  alg_secanterec_funcion(fun,x1,x2,error,iter,contador);
	end
